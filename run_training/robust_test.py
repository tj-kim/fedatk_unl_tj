...
if __name__ == "__main__":
    ...
    exp_names = ['FAT_tm','FAT_md','FAT']
    exp_method = ['FedAvg_adv','FedAvg_adv','FedAvg_adv']
    agg_ops = ['trimmed_mean','median', None]
    save_folder = 'weights/cifar10/240115_robust_tests/'
    ...
    for itt in range(len(exp_names)):
        ...
        print("running trial:", itt, "name:", exp_names[itt])
        ...
        while current_round <= args_.n_rounds:
            ...
            if exp_method[itt] == 'FedAvg_adv':
                if  current_round != 0 and current_round%Q == 0: # 
                    print("Round:", current_round, "Updating Adv Dataset")
